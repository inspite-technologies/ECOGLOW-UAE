...
const PackagesManager = () => {
  ...
  const [packagesData, setPackagesData] = useState({
    ...
    residential: {
      ...
      externalLink: "",
      whatsappLink: "",
      card1: { title: "", features: "", price: "", min: "", depend: "" },
      card2: { title: "", features: "", price: "", min: "", depend: "" },
      // ✅ Added Common
      ...
      try {
        ...
        const migratedTables = (data.tables || []).map(table => {
          ...
          return {
            ...
            columns: cols,
            rows: rows,
            externalLink: table.externalLink || table.bookNow || "",
            whatsappLink: table.whatsappLink || table.whatsappNow || ""
          };
        });
        ...
        setPackagesData({
          ...
          residential: {
            ...
            externalLink: data.residential?.externalLink || "",
            whatsappLink: data.residential?.whatsappLink || "",
          ...
          commercial: {
            ...
            externalLink: data.commercial?.externalLink || "",
            whatsappLink: data.commercial?.whatsappLink || "",
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
        ...
        <section style={cardWrapper}>
          ...
          <div style={{ marginBottom: '20px', display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '15px' }}>
            <input style={inputStyle} value={packagesData.residential.heading} onChange={(e) => handleSectionFieldChange('residential', 'heading', e.target.value)} placeholder="Residential Heading" />
            <input style={inputStyle} value={packagesData.residential.externalLink} onChange={(e) => handleSectionFieldChange('residential', 'externalLink', e.target.value)} placeholder="Section Book Link (https://ecoglow.ae/)" />
            <input style={inputStyle} value={packagesData.residential.whatsappLink} onChange={(e) => handleSectionFieldChange('residential', 'whatsappLink', e.target.value)} placeholder="Section WhatsApp (https://wa.me/...)" />
          </div>
        ...
        <section style={cardWrapper}>
          ...
          <div style={{ marginBottom: '20px', display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '15px' }}>
            <input style={inputStyle} value={packagesData.commercial.heading} onChange={(e) => handleSectionFieldChange('commercial', 'heading', e.target.value)} placeholder="Commercial Heading" />
            <input style={inputStyle} value={packagesData.commercial.externalLink} onChange={(e) => handleSectionFieldChange('commercial', 'externalLink', e.target.value)} placeholder="Section Book Link (https://ecoglow.ae/)" />
            <input style={inputStyle} value={packagesData.commercial.whatsappLink} onChange={(e) => handleSectionFieldChange('commercial', 'whatsappLink', e.target.value)} placeholder="Section WhatsApp (https://wa.me/...)" />
          </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px', marginBottom: '20px', background: '#f8fafc', padding: '15px', borderRadius: '10px', border: '1px dashed #cbd5e1' }}>
                <div>
                  ...
                  <input
                    ...
                    value={table.externalLink || ""}
                    onChange={(e) => updateTableMetadata(tIdx, 'externalLink', e.target.value)}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    value={table.whatsappLink || ""}
                    onChange={(e) => updateTableMetadata(tIdx, 'whatsappLink', e.target.value)}
                  />
                </div>
              </div>
