...
function Contact() {
  ...
  if (!settings) return null; // Or a simple loading spinner
    ...
    <>
      ...
      <div className="breadcrumbs-wrapper">
        <div className="breadcrumbs-container">
          ...
          <span className="breadcrumb-link">{settings.formLabel}</span>
          <span className="breadcrumb-separator">/</span>
          <span className="breadcrumb-active">CONTACT ECOGLOW</span>
        </div>
      </div>
            ...
            <form onSubmit={handleSubmit} className="contact-form-large">
              <div className="form-row-grid">
                <div className="form-group-large">
                  ...
                  <input type="text" id="firstName" name="firstName" value={formData.firstName} onChange={handleChange} className="form-input-large" required />
                </div>
                <div className="form-group-large">
                  <label htmlFor="lastName">Last Name</label>
                  <input type="text" id="lastName" name="lastName" value={formData.lastName} onChange={handleChange} className="form-input-large" required />
                </div>
              </div>
              ...
              <div className="form-row-grid">
                <div className="form-group-large">
                  ...
                  <input type="email" id="email" name="email" value={formData.email} onChange={handleChange} className="form-input-large" required />
                </div>
                <div className="form-group-large">
              ...
              <div className="form-group-large full-width">
                ...
                <textarea id="message" name="message" value={formData.message} onChange={handleChange} className="form-textarea-large" rows="6" required></textarea>
              </div>
              ...
              {formStatus === 'error' && (
                <div className="form-message error">❌ Failed to send message. Please check all fields and try again.</div>
              )}
            </form>
          </div>
